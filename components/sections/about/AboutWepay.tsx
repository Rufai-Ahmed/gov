...
const AboutWepay = () => {
  ...
  return (
    <div id="about-us" className="min-h-screen bg-[#e6fff5] dark:bg-[#043024] flex items-center justify-center mt-3 p-6">
        ...
        <div className="space-y-6">
          ...
          {isDarkMode ? (
            <p className="text-white text-lg leading-relaxed">
              ...
              Africa with better biometric technology. Our strong setup dey work
              with big fintech companies, banks, and local agents all over the
              continent, to build network wey dey empower people wey no get
              enough access to banking with secure and inclusive financial
              services. With WePay, you fit do money transactions with only your
              fingerprint—no need for card or smartphone. This way dey make
              payment simple and give everybody, especially people for
              underbanked places, power to join digital economy with confidence.
              For WePay, we no just dey do digital banking, we dey do identity
              banking. We dey build bridge where normal banking dey put wall.
            </p>
          ) : (
